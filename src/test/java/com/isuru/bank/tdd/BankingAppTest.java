    ...
    class Transactions_01 {
        ...
        void setUp() {
            ...
            List<Transaction> transactions = Arrays.asList(transaction_1, transaction_2, transaction_3, transaction_4,
                    transaction_5, transaction_6, transaction_7, transaction_8, transaction_9, transaction_10);
        ...
        void getCumulativeBalance_test_01() throws CustomerNotFoundException {
            ...
            Assertions.assertEquals(1200.00, value);
        }

        @Test
        void getCumulativeBalance_test_02() throws CustomerNotFoundException {
            bankingApp.setUp();
            double value = bankingApp.getCumulativeBalance("3");
            Assertions.assertEquals(-100.00, value);
        }
        ...
        void getMonthlyBalance_test_scenario_03() throws CustomerNotFoundException {
            bankingApp.setUp();
            double value = bankingApp.getMonthlyBalance("3", "03", "2022");
            Assertions.assertEquals(-600.00, value);
        }

        @Test
        void getMonthlyBalance_test_scenario_04() throws CustomerNotFoundException {
            bankingApp.setUp();
            double value = bankingApp.getMonthlyBalance("4", "03", "2022");
            Assertions.assertEquals(-800.00, value);
        }
